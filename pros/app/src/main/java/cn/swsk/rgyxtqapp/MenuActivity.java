...
//    }
     ...
     * 更新推送渠道ID
     */
    protected void upPushChannelId() {
        String path = "http://" + PushUtils.getServerIPText(this) + "/rgyx/appUser/upPushChannelId?pushChannelId=" + PushUtils.channelId + "&token=" + PushUtils.token;
