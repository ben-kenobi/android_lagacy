...
public interface IConstants {
    ...
    SimpleDateFormat TIMESDF2 = new SimpleDateFormat("yyyyMMddHHmmss");
...
//    String getDefServerIP="61.154.9.242:5551";
    ...
    String instructionList="fjseism/ma/cm/command/findInstructionsList";
    String submitLocation="fjseism/ma/gps/subLocation";
    String pushChannelIdUrl="fjseism/ma/user/upPushChannelId";
...
//    String pushMapServicePattern="http://3dspace.xicp.net:20081/geoserver/fjseism/wms" ;
    ...
    String eqFilePrefix = "fjseism_files/HA/report/";


    String lifelineLayerInfoUrl = "fjseism/ma/thematicmap/lifelineLayerInfoList";
    String dis_themMap_url = "geoserver/fjseism/wms";
    String map_slice_url="fjseism/ma/thematicmap/getMapInfo";
    String contactListUrl="fjseism/ma/sm/contacts/findList";
}
