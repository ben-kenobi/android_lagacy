...
public class PopInfos {
    ...
    public static final  int[]	pickerOptionIcons=new int[]{R.mipmap.forsubmit,
            R.mipmap.datas,R.mipmap.eathquakehis,R.mipmap.evaluate,R.mipmap.dicision,
            R.mipmap.dicision,R.mipmap.dicision,
            R.mipmap.settings};
    ...
    public static final  String[]	distributions=new String[]{"烈度","人员死亡分布图"
            ,"人员受伤分布图","房屋倒塌分布图","经济损失分布图"};
    public static final  int[]	distributionIcons=new int[]{R.mipmap.ic_density,
            R.mipmap.ic_mendown,R.mipmap.ic_meninjury,R.mipmap.ic_housedamage,R.mipmap.ic_economiclost};

    public static final int[] sampleImgResIds={R.mipmap.density,R.mipmap.mendown,
            R.mipmap.meninjury,R.mipmap.housedamage,R.mipmap.economiclost};
