 ...
 */
public class PendingSubmissionActivity2 extends BaseTopbarActivity implements View.OnClickListener,AdapterView.OnItemClickListener,Runnable{
...
//        mTopbar.setRightButtonIsvisable(false);
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        if(adapter.editMode||adapter.isUploadAt(position))
            return ;
