...
public class EmergencyAdapter extends CommonAdapter<DocFile> implements View.OnClickListener {
    ...
    public void convert(ViewHolder holder, final DocFile docFile) {
        ...
        holder.setText(R.id.size, FileUtils.formatFileSize2(docFile.size));
        if (docFile.genTime!=null) {
        ...
        holder.setText(R.id.btn, !new File(docFile.path).exists()&&docFile.url!=null ? "下载" : "查看");
        ...
        if(docFile.size<=0 && docFile.url!=null){
