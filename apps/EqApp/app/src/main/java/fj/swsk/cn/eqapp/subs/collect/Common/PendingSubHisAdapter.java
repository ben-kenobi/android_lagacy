 ...
 */
public class PendingSubHisAdapter extends BaseAdapter  implements View.OnClickListener{
    Context mContext;
    public List<Tscene> list=new ArrayList<>();
    public List<PendingSubGVAdapter> adapters = new ArrayList<>();
    int resid = R.layout.pending_submission_his_innergv;

    public boolean mulSelMode=false;
    public boolean editMode=false;
    public int flag = 0;

    public PendingSubHisAdapter(Context con) {
        super();
        this.mContext=con;
