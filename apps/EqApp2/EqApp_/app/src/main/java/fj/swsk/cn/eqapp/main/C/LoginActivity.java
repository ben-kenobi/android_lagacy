...
public class LoginActivity extends BaseActivity implements View.OnClickListener{
    ...
    private void login(){
        ...
        String path = IConstants.loginUrl + "?name=" + CommonUtils.UrlEnc(txt_userName.getText().toString()) + "&password=" + txt_password.getText().toString();
