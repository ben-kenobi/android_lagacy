...
public class PopInfos {
    ...
    public static final  String[]	distributions=new String[]{"烈度","房屋倒塌分布图","人员死亡分布图"
            ,"人员受伤分布图","经济损失分布图"};
    public static final  int[]	distributionIcons=new int[]{R.mipmap.view,R.mipmap.view,
            R.mipmap.view,R.mipmap.view,R.mipmap.view};
...
//            ,"水电站","燃气站","学校","医院","疏散场地","安置区域"};
    ...
    public static final  int[]	controlflowsIcons=new int[]{R.mipmap.town,R.mipmap.town,
            R.mipmap.town,R.mipmap.town,R.mipmap.town,R.mipmap.town,R.mipmap.town};
