package com.what.yunbao.animation;
...
public class MyAnimations{
	...
	public static void startAnimationsOut(View view, int durationMillis) {

		MarginLayoutParams mlp = (MarginLayoutParams) view.getLayoutParams();
		Animation animation = new TranslateAnimation(0F,0F, 0F,mlp.bottomMargin+46);
